...
#warning Incomplete method implementation.
    ...
    if ( section == 0 ){ //first section
        return 2;//num of rows in first section
    }else if( section == 1 ){ //second section
        return 1; //num of rows in second section
    }else{ //third section
        return 3; //num of rows in third section
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    // In each section the rows start at zero
